/* 
 * Affine transform of a list of "edgelets". An edgelet is a 2D point with its orientation and scale (length). 
 *
 * Usage:
 *    [outRow, outCol, outO, outS] =
            c_TemplateAffineTransform(tScale,rScale,cScale,rotation,inRow,inCol,inO,inS,nOri)
 * 
 * 
 */
# include <stdio.h>
